...
const READ_TIME_SECONDS = 15;

function InstructionsScreen({ onStart, onBack }: InstructionsScreenProps) {
    ...
    <main className="min-h-[calc(100vh-80px)] bg-[#0d0704] px-6 py-12 text-white">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="text-center">
          ...
          <h1 className="mt-6 text-4xl font-extrabold md:text-5xl">How to Play</h1>
        ...
        <section className="mt-12 grid gap-5 md:grid-cols-4">
          <div className="rounded-2xl border border-amber-500/20 bg-[#160b06] p-6">
            ...
            <h2 className="mt-4 text-xl font-bold">Listen</h2>
          ...
          <div className="rounded-2xl border border-amber-500/20 bg-[#160b06] p-6">
            ...
            <h2 className="mt-4 text-xl font-bold">Draw</h2>
            <p className="mt-2 text-sm leading-6 text-white/55">
          ...
          <div className="rounded-2xl border border-amber-500/20 bg-[#160b06] p-6">
            <div className="text-3xl font-black text-amber-400">03</div>
            <h2 className="mt-4 text-xl font-bold">Get Distracted</h2>
            <p className="mt-2 text-sm leading-6 text-white/55">
          ...
          <div className="rounded-2xl border border-amber-500/20 bg-[#160b06] p-6">
            ...
            <h2 className="mt-4 text-xl font-bold">Recall</h2>
            <p className="mt-2 text-sm leading-6 text-white/55">
        ...
        <section className="mt-8 rounded-2xl border border-amber-500/30 bg-gradient-to-r from-[#1d0e06] to-[#291406] p-8">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div>
              <p className="text-sm font-semibold text-amber-300">PRACTICE ROUND</p>
              <h2 className="mt-2 text-2xl font-bold">Ready to test Sketch Recall?</h2>
              <p className="mt-2 text-sm text-white/55">Start with a short drawing sequence.</p>
            </div>

            <div className="flex flex-col items-center gap-2">
              <div className="rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 px-8 py-4 font-bold text-black">
                Starting in {secondsLeft}s…
              </div>
              <p className="text-xs text-white/40">Get ready to draw!</p>
            </div>
          </div>
        </section>
      </div>
